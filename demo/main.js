...
(function () {
	...
	.directive("ngCronInput", function ( $timeout, ACDService, REPEAT_TYPE) {
		return {
			template: cronExpressionInputTemplate,
			restrict: 'E',
			require: '^ngModel',
			scope: {
				ngModel: '='
	...
	.directive("ngNextCronDates", function ($timeout, REPEAT_TYPE) {
		return {
			template: cronNextDatesTemplate,
			restrict: 'E',
			require: '^ngModel',
			scope: {
				ngModel: '=',
